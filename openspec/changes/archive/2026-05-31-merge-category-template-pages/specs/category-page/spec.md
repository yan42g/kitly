...
**Reason**: Une catégorie ne contient qu'un seul template (la diversité interne est portée par les propositions et les variantes) ; la liste de templates est donc redondante et impose un clic sans valeur.
**Migration**: Le détail du template est désormais rendu directement par la page catégorie — voir la nouvelle exigence « Détail du template d'une catégorie ».
